...
var ReactForms = /** @class */ (function(_super) {
  ...
  ReactForms.prototype.getFormElements = function(
    configs,
    callbacks,
    store,
    groupId,
    ...
    return configs.map(function(config, i) {
      ...
      _this.errors[groupId] = _this.errors[groupId] || []
      _this.errors[groupId][i] = {
        id: config.id,
        error: error,
      }
      var props = {
