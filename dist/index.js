;(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define(['react', 'rc-tooltip', 'shortid'], factory)
      : ((global.index = global.index || {}),
        (global.index.js = factory(global.React, global.Tooltip, global.id)))
})(this, function(React, Tooltip, id) {
  'use strict'
...
***************************************************************************** */
      ...
      var helpText =
        ...
        React.createElement(
          ...
          __assign(
            {
              placement: 'top',
              overlay: React.createElement('span', null, config.helpText),
            },
  ...
  var InputGeneric = function(_a) {
    var _b = _a.value,
      ...
      config = _a.config,
      _c = _a.callbacks,
      callbacks = _c === void 0 ? {} : _c
    return React.createElement(
      'div',
      { className: cn$1('form-Element', 'input-text', config.className) },
      React.createElement(
        'input',
        __assign({}, callbacks, config.componentProps, {
          type: config.type,
          value: value,
  ...
  var InputToggle = function(_a) {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'input',
          __assign({}, callbacks, componentProps, {
            checked: value,
  ...
  var ReactForms = /** @class */ (function(_super) {
        ...
        if (callbacks[event]) {
          bindedCallbacks[event] = function() {
            ...
            if (_this.props.useNativeEvent || event !== 'onChange') {
              callbacks[event].apply(
                null,
                (_a = [config]).concat.apply(_a, args),
              )
            } else {
    ...
    ReactForms.prototype.getFormElements = function(configs, callbacks, store) {
      ...
      return configs.map(function(config, i) {
        ...
        return React.createElement(
          ReactFormTemplate,
          {
            error: (_this.state.validate || config.instantValidation) && error,
            config: config,
            store: store,
            key: config.id,
          },
          Element ? React.createElement(Element, __assign({}, props)) : null,
        )
      })
    }
    ReactForms.prototype.render = function() {
      var _a = this.props,
        ...
        onSecondaryButtonClick = _a.onSecondaryButtonClick
